...
parser.add_argument('--in_dir', default="/media/deadcrow/6TB/python_project/MatSeg-Synthethic-Dataset-Generation-Script-main/out_generated_data_extracted_Pbrs_xxxxxx/548/", type=str, help='target image')
parser.add_argument('--out_dir', default="", type=str, help='target image')
...
out_vid = out_dir +"/video.mp4"

frame=0
if __name__ == "__main__":
            for iii in range(10000):
                im_file= args.in_dir+"/RGB_"+str(iii)+"_RGB.jpg"
